...
const About = () => {
  return (
    <div className="max-w-5xl mx-auto px-6 py-12">
      <h1 className="text-4xl font-bold mb-6 text-center">About WallScape</h1>
      ...
      <h2 className="text-2xl font-semibold mt-8 mb-4">Wallpaper Sizes</h2>
      ...
      <h2 className="text-2xl font-semibold mt-8 mb-4">Printing & Material Options</h2>
      <ul className="list-disc pl-6 text-gray-700">
        <li>
